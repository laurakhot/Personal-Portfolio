...
>
        ...
        <form className="mt-10 flex flex-col">
            <input type="email" required maxLength={500} placeholder="Your email" className="px-4 h-14 rounded-lg borderBlack"/>
            <textarea placeholder="Type your message here" required maxLength={500} className="h-52 my-3 rounded-lg borderBlack p-4"/>
